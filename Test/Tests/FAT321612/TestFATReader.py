...
class TestFATReader(unittest.TestCase):
    ...
    @patch('FAT321612.FATReader.FATReader._FATReader__read_block')
    def test_parse_super_block(self, mock_foo):
        fat32_obj = FATObject.FATFileSys()
        ...
        mock_foo.return_value = b'\xeb\x58\x90\x6d\x6b\x66\x73\x2e\x66\x61\x74\x00\x02\x08\x20\x00' \
        ...
        print(fat.file_system.__dict__, '\n', fat32_obj.__dict__, '\n',
              fat.file_system.__dict__ == fat32_obj.__dict__)

        self.assertEqual(fat.file_system.__dict__, fat32_obj.__dict__)
